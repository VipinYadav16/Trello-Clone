  ...
  lists: [
    ...
    },
    {
      ...
      cards: [
        ...
        {
          id: uid(),
          title: "Integrate audit logging",
          description: "Track sensitive user actions for compliance",
          labels: [{ id: uid(), text: "Backend", color: "green" }],
          memberIds: ["m3"],
          dueDate: "2026-03-22",
          checklists: [],
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          description: "Address review comments before merge",
          labels: [{ id: uid(), text: "Backend", color: "green" }],
          memberIds: ["m1"],
          dueDate: "2026-03-19",
          checklists: [],
    ...
    },
    {
      ...
      cards: [
        {
          id: uid(),
          title: "Regression test checkout flow",
          description: "Validate payment edge cases before release",
          labels: [{ id: uid(), text: "QA", color: "orange" }],
          memberIds: ["m2"],
          dueDate: "2026-03-21",
          checklists: [],
        ...
        {
          id: uid(),
          title: "Cross-browser smoke tests",
          description: "Run Chrome, Edge, and Safari regression suite",
          labels: [{ id: uid(), text: "QA", color: "orange" }],
          memberIds: ["m4"],
          dueDate: "2026-03-23",
          checklists: [],
      ...
      cards: [
        {
          ...
          description: "Blocked until SOC team signs off",
          labels: [{ id: uid(), text: "Blocked", color: "red" }],
          memberIds: ["m3"],
          dueDate: null,
          checklists: [],
          comments: [],
        ...
        {
          id: uid(),
          title: "Third-party API rate limit increase",
          description: "Waiting for vendor operations approval",
          labels: [{ id: uid(), text: "Blocked", color: "red" }],
          memberIds: ["m3"],
          dueDate: null,
          checklists: [],
